                      ...
                      filteredData?.map((a) => (
                        <tr>
                          ...
                          <td className="py-[2%] text-center text-nowrap">
                            <button className='bg-gray-300 p-2 rounded' onClick={() => {alert("added"); const oldData = JSON.parse(localStorage.getItem("ordersAtWarehouse")) || []; localStorage.setItem("ordersAtWarehouse", JSON.stringify([...oldData, ...filteredData])); setResult(null) }}>Add</button></td>
